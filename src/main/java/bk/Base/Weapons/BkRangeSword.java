...
import bk.Base.Entity.BkSwordEntity;
...
public class BkRangeSword extends BkSword {
     ...
     */
    public void performAttack(EntityPlayer player,  Entity targetEntity)
    {
        ...
        //player.getHeldItemMainhand().hitEntity((EntityLivingBase) targetEntity, player);
    ...
    public void attackTask(EntityPlayer player,  Entity targetEntity){
